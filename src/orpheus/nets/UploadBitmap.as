package orpheus.nets
{
	...
	public class UploadBitmap
	{
		...
		{	
			...
			var objJPEGEnc:JPEGEncoder = new JPEGEncoder(100);   
		...
		{
			urlRequest.data = UploadPostHelper.getPostData("flashImage.jpg",getByteArray(bitmap),param);
