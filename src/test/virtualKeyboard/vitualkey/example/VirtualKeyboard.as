package test.virtualKeyboard.vitualkey.example
{
	...
	public class VirtualKeyboard
	{
		...
		private var $activeTxtNum:int = 0;
		/**	한글인지 여부 **/
		...
		private function setEvent():void
		{
			...
			for (var j:int = 0; j < $txtNum; j++) 
			{
				var tf:TextField = _container["txt"+j];
		...
		protected function onFocus(event:FocusEvent):void
		{
			...
			$activeTxtNum = int(tf.name.charAt(tf.name.length-1));
			trace("$activeTxtNum: ",$activeTxtNum);
		...
		{
			var tf:TextField = _container["txt"+$activeTxtNum];
			var value1:String;
			var value2:String;
			var str:String;
